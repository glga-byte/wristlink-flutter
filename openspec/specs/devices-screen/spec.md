...
#### Scenario: Devices tab opens with physical devices
...
- **THEN** the system keeps the previous physical device list and exposes the failure as user-presentable state
